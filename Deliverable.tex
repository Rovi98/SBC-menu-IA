...
\begin{itemize}
	...
	\item \textbf{Platos, ingredientes, enfermedades, nutrientes...}: el conjunto de conocimiento que necesita nuestro SBC para poder operar ha sido obtenido utilizando recursos en la red, especialmente se ha usado documentación especializada en el tema. 
\end{itemize}
